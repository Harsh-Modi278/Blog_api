            ...
            else
            {
                ...
                .then(
                    (post)=>
                    {
                        ...
                        .then(()=>
                        {
                            Post.findByIdAndUpdate(req.params.postId,{commentsArray:temp},{new:true})
                            .then(
                                (result)=>res.json(result)
                            )
                            .catch((err)=>console.error(err));
...
module.exports = {adminPosts_get, adminPosts_post, adminPostId_put, adminPostId_delete, adminPostIdCommentId_delete,adminLogin_post};